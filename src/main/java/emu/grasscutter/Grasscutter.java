...
public final class Grasscutter {
	...
	public static void loadConfig() {
		...
		try (FileReader file = new FileReader(configFile)) {
			...
			GameServer.doExit(0,"There was an error while trying to load configuration from config.json. Please make sure that there are no syntax errors. If you want to start with a default configuration, delete your existing config.json.");
		} 
	}
